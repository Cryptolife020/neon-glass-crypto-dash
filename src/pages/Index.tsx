    ...
    >
      ...
      <main className="flex-1 p-4 lg:p-8 lg:ml-0 ml-0" data-oid="bg7v0:i">
        ...
        >
          ...
          <div className="flex items-start gap-2 lg:gap-3 mr-4 lg:mr-24" data-oid="vsd3myq">
            <div
              className="px-2 lg:px-4 py-2 glass-card rounded-xl h-16 lg:h-20 flex flex-col justify-center min-w-0 flex-1 lg:flex-none lg:w-auto"
              data-oid="ew-dn-h"
            >
              <div className="flex items-center gap-1 lg:gap-2 mb-1" data-oid="b6lgqfa">
                <Target
                  className="w-3 h-3 lg:w-4 lg:h-4 text-yellow-400 flex-shrink-0"
                  data-oid="nao4qoy"
                />
                <span
              ...
              <p
                className="text-sm lg:text-xl font-bold text-yellow-400 truncate"
                data-oid="lu.iu:x"
              >
                $30,000.00
              </p>
            ...
            <div
              ...
              data-oid="ackey8e"
            >
              <div className="flex items-center gap-1 lg:gap-2 mb-1" data-oid="y0p9wj3">
              ...
              <p
                className="text-sm lg:text-xl font-bold text-green-400 truncate"
                data-oid=":400pbp"
              >
                $24,847.52
              </p>
            ...
            <div
              ...
              data-oid="aygi00y"
            >
              <div className="flex items-center gap-1 lg:gap-2 mb-1" data-oid="q15oy02">
                <TrendingUp
                  className="w-3 h-3 lg:w-4 lg:h-4 text-neon-blue-400 flex-shrink-0"
                  data-oid="e1eqbno"
                />
                <span
                  className="text-xs text-gray-400 truncate"
              ...
              <p
                className="text-sm lg:text-xl font-bold text-neon-blue-400 truncate"
                data-oid="wijoc7c"
              >
                $3,247.18
              </p>
